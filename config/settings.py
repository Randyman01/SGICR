...
SECRET_KEY = 'django-insecure-7!wn&ep@e@42l-=ac3mn0c-y!e_=@ph69$*o3uli76^x64=#pz'
...
# Define la ruta donde se almacenarán los archivos estáticos
STATIC_URL = '/static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')

# Define la ruta donde se almacenarán los archivos multimedia
MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'app/sgicr/media')
